...
const ItemInputs = () => {
  ...
  return (
    <View>
      <CustomText content="Title" style={styles.inputLabel} />
      <TextInput
        style={[
          styles.input,
          {
      ...
      <CustomText content="Location" style={styles.inputLabel} />
      <TouchableOpacity
        style={[
          styles.input,
          {
      ...
      >
        <Text style={{ color: form.location ? colors["black-font"] : colors["dark-gray-dark-theme"] }}>
      ...
      <CustomText content="Condition" style={styles.inputLabel} />
      ...
      <CustomText content="Description" style={styles.inputLabel} />
      <TextInput
        style={[
          styles.textArea,
          {
